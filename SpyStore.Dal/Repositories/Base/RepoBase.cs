...
namespace SpyStore.Dal.Repositories.Base
{
    public abstract class RepoBase<T> : IRepo<T> where T : EntityBase, new()
    {
        ...
        // Expression parameter that allows a dynamically generated OrderBy clause.
        ...
        public int SaveChanges()
        {
            ...
            catch (DbUpdateException ex)
            {
                ...
                if (ex.InnerException is SqlException sqlException
                    && sqlException.Message.Contains("FOREIGN KEY constraint", StringComparison.OrdinalIgnoreCase))
                {
