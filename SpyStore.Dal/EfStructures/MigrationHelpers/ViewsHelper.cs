...
namespace SpyStore.Dal.EfStructures.MigrationHelpers
{
    public static class ViewsHelper
    {
        ...
        {
            builder.Sql(@"CREATE VIEW [Store].[OrderDetailWithProductInfo] AS
        ...
        public static void CreateCartRecordWithProductInfoView(
        MigrationBuilder builder)
        {
            builder.Sql(@" CREATE VIEW [Store].[CartRecordWithProductInfo] AS
