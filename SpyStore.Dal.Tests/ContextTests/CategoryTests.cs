...
namespace SpyStore.Dal.Tests.ContextTests
{
    ...
    public class CategoryTests : IDisposable
    {
        ...
        public void ShouldNotUpdateANonAttachedCategory()
        {
            ...
            _db.Categories.Add(category);
            category.CategoryName = "Bar";
            //This uses the xUnit Assert that confirms an exception if the specified type was
            //thrown.If the exception is thrown, the test passes.If it doesn’t get thrown, the test fails.
